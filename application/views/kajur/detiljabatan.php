        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <?php if(isset($detilJabatan)): ?>
              <form method="post" action="<?php echo base_url(). '/kajur/jabatan/edit'; ?>">
              ...
              <?php echo anchor('kajur/jabatan/delete/'.$detilJabatan['id'],'Hapus', array('onclick' => "return confirm('Yakin ingin menghapus?')",'class'=>'form-group btn btn-danger') ); ?>
            </form>
          <?php endif; ?>
        </div>
