    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          Ubah Dokumen</div>
          <div class="card-body">
            <form method="post" action="<?php echo base_url(). '/dokumen/edit'; ?>">
              <input type="hidden" name="id" id="id" value="<?=$dokumen['id']?>" class="form-control" placeholder="id" required="required">

              <div class="form-group">
                <div class="form-label-group">
                  <input type="text" name="namalama" id="nama" value="<?=$dokumen['nama']?>" class="form-control" placeholder="Kategori" required="required" disabled>
